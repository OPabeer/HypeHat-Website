...
export const HeartIcon: React.FC<IconProps> = ({ filled, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" fill={filled ? "currentColor" : "none"} {...props}>
...
export const SparklesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-9l2-2 2 2m-2-2v6m-2 4l2 2 2-2m-2 2v-6m-6-1l-2-2-2 2 2 2z" />
    </svg>
);
...
export const BotIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8V4m0 12v-4m-4-4H4m6 0H8m6 0h2m-2 0h-2m6 4h2m-2 0h-2m-4 4H8m6 0h-2M8 8a4 4 0 108 0 4 4 0 00-8 0z" />
    </svg>
);
...
export const TruckIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M0 5.396h12.553v10.42H0V5.396z" transform="translate(8.447 2.787)"/>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1.383 15.816h4.51V5.396h-1.63c-1.59 0-2.88 1.29-2.88 2.88v7.54zM12.553 11.702H21" transform="translate(0 2.787)"/>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11.17 21a2.766 2.766 0 10-5.532 0 2.766 2.766 0 005.532 0zM21 21a2.766 2.766 0 10-5.532 0 2.766 2.766 0 005.532 0z"/>
    </svg>
);
